   ...
   stage('Cloning Git') {
    ...
    stage('Creating self signed certificate') {
             steps {
                  ...
                  sh 'echo Generate demo rootca key '
                  sh 'keytool -genkey -keyalg RSA -alias dummy -keystore dummy.jks -storepass 123456 -validity 1024 -keysize 2048 -dname "CN=dummy, O=London, L=London, S=London, C=UK, OU=London"'
                  sh 'echo Generate key and CSR for dem certificate'
